...
function Game(canvas) {
	...
	function powerConstructor(cnv) {
		...
		var images = {
			"BlueBlock": "img/btile.png",
			"RedBlock": "img/rdtile.png",
			"GreenBlock": "img/gtile.png",
			"YellowBlock": "img/ytile.png",
			"YellowBreaker": "img/ybreak.png",
			"BlueBreaker": "img/bbreak.png",
			"GreenBreaker": "img/gbreak.png",
			"RedBreaker": "img/rbreak.png"
		}
